...
export const es: PortfolioContent = {
  ...
  about: {
    paragraphs: [
      "No llegué al software por el camino esperado. Durante más de 10 años trabajé en un taller mecánico diseñando y fabricando maquinaria industrial. Saber hacer cosas con las manos es valioso, pero depender de eso para vivir es físicamente desgastante — los pulmones, las piernas, los oídos, la radiación de las máquinas de soldar. Es algo que mi padre sufre hoy y que yo quise evitar para mi futuro.",
      "En medio de esa inquietud descubrí la programación de PLCs con lenguaje ladder y sistemas automatizados. En mi provincia nadie desarrollaba eso, y era justo lo que necesitaban las fraccionadoras de azúcar y las ladrilleras automatizadas que fabricábamos. Me fascinó que algo pudiera funcionar solo gracias a código. Esa curiosidad me llevó a las impresoras 3D — el diseño 3D se me hizo natural porque venía del dibujo técnico, del conocimiento de máquinas y materiales. Solo había que reducir la escala. Llegué a Emme 3D con 10 impresoras funcionando en simultáneo.",
      "Ahí apareció la programación web. Hice Argentina Programa, un curso de QA Testing, y en el medio surgió este trabajo en el Poder Judicial de Tucumán. Como ya manejaba bien las computadoras, me ubicaron en sistemas. Hoy trabajo ahí por las mañanas y sigo formándome como desarrollador por las tardes. Construyo aplicaciones full stack con React, Node.js, Express y PostgreSQL. Mi diferencial: uso la IA estratégicamente — spec-driven development, evaluación de modelos, optimización de contextos. No es el camino típico. Pero cada paso, desde el taller hasta el código, suma.",
    ],
