...
export const es: PortfolioContent = {
  ...
  construction: {
    ...
    message: "Este portfolio está en construcción. El contenido completo estará disponible próximamente.",
  },
  ...
  skills: [
    {
      ...
      items: [
        { name: "Lorem ipsum dolor", icon: "react" },
        { name: "Consectetur", icon: "typescript" },
        { name: "Adipiscing elit", icon: "nextjs" },
        { name: "Sed do eiusmod", icon: "tailwindcss" },
        { name: "Tempor incididunt", icon: "astro" },
        { name: "Ut labore et", icon: "html" },
        { name: "Dolore magna", icon: "javascript" },
      ],
    },
    {
      ...
      categoryKey: "backend",
      items: [
        { name: "Aliqua quis", icon: "nodejs" },
        { name: "Nostrud", icon: "express" },
        { name: "Exercitation", icon: "postgresql" },
        { name: "Ullamco laboris", icon: "prisma" },
        { name: "Nisi ut aliquip", icon: "mysql" },
        { name: "Commodo", icon: "api" },
        { name: "Consequat", icon: "jwt" },
        { name: "Duis aute", icon: "git" },
      ],
    },
    {
      category: "Irure dolor",
      categoryKey: "tools",
      items: [
        { name: "In reprehenderit", icon: "docker" },
        { name: "Voluptate velit", icon: "linux" },
        { name: "Esse cillum", icon: "vscode" },
        { name: "Dolore eu", icon: "figma" },
        { name: "Fugiat nulla", icon: "vercel" },
        { name: "Pariatur", icon: "vite" },
        { name: "Excepteur", icon: "postman" },
      ],
    },
    {
      category: "Sint occaecat",
      categoryKey: "industrial",
      items: [
        { name: "Cupidatat non", icon: "wrench" },
        { name: "Proident sunt", icon: "settings" },
        { name: "In culpa qui", icon: "search" },
        { name: "Officia deserunt", icon: "shield" },
      ],
    },
  ],
