...
export const es: PortfolioContent = {
  ...
  about: {
    paragraphs: [
      "No llegué al software por un camino tradicional. Durante más de 10 años trabajé junto a mi padre en un taller de metalmecánica reparando, diseñando, fabricando y comercializando maquinaria; ahí aprendí a entender el comportamiento de los materiales, la lógica de las máquinas grandes y a resolver problemas. Pero esto no me dejaba satisfecho, pues noté que saber manejar máquinas herramientas y hacer cosas con las manos es valioso, pero con el paso de los años depender de eso para vivir es físicamente desgastante.",

      "En medio de esa inquietud, para diferenciarnos de la competencia, integramos la programación de sistemas automatizados con diagramas Ladder y PLCs. Era justo lo que estaba buscando: me fascinó que algo pudiera funcionar en el mundo físico solo gracias al código. Esa curiosidad me llevó rápidamente a las impresoras 3D; el diseño 3D se me hizo natural porque venía del dibujo técnico y del conocimiento de máquinas y materiales. Solo había que reducir la escala. Llevé a mi emprendimiento, Emme 3D, a tener 10 impresoras funcionando en simultáneo, lo que me dio experiencia y horas de trabajo en la PC.",

      "Ahí apareció la programación web. Hice la primera etapa de Argentina Programa (un curso de inicio en el mundo de la lógica de programación), un curso de QA Testing y luego continué estudiando por mi cuenta. En el medio surgió mi puesto en el Poder Judicial de Tucumán: como demostré buen manejo informático, me ubicaron en sistemas. Hoy trabajo ahí por las mañanas en Soporte IT y Seguridad Informática, y por las tardes sigo realizando cursos, programando y formándome como desarrollador.",

      "Hoy soy capaz de construir aplicaciones full-stack con React, Node.js, Express y PostgreSQL. Mi diferencial: uso la IA estratégicamente —spec-driven development, evaluación de modelos y optimización de contextos. No es el camino típico, pero cada paso, desde el taller hasta el código, me dio herramientas que hoy quiero aplicar en mi próximo desafío profesional.",
    ],
